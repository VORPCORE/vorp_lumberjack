...
Config.Items = {
    ...
    {name = "honey", label = "Honing", chance = 5, amount = 2},
    {name = "wood", label = "Zacht hout", chance = 10, amount = 5},
    {name = "hwood", label = "Hard Hout", chance = 8, amount = 5},
    {name = "rubber", label = "Rubber", chance = 5, amount = 4},
    {name = "fibers", label = "Vezels", chance = 8, amount = 5},
